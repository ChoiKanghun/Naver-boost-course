...
<input type ="text" id="current_category" value = "0" style="display:none"></input>
    <div id="container">
        <div class="header">
        ...
        <div class="event">
                        ...
                        <div>
                            <div class="container_visual">
                                ...
                                <ul class="visual_img">
                                 ...
                                 <%-- <c:forEach items="${promotionThList}" var="image">
        								<li><img src="img/${image.productId}_th_${image.id}.png"/></li>
									</c:forEach> --%>
                            </div>
         ...
         <!--    --> 
            ...
            <!-- test test test test test test test test test test test test test
            	...
            	<c:forEach items="${displayInfoList}" var="image">
        			${image.placeName }<br>
				</c:forEach>
						
			 test test test test test test test test test test test test--> 			            
                <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">{productCount}개</span> 있습니다</p>
...
<!-- <script src = "js/makeMore.js"></script> -->
</html>
