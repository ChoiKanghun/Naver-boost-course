  ...
  <div id="container">
    ...
    <div class="ct main">
      <div>
        ...
        <div class="section_btn"> <button type="button" onclick="" class="bk_btn"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
...
{{/if}}
       ...
       <div class="review_info"> 
		...
		<span class="date">
			{{customDateFormat createDate}}&nbsp;방문
		</span> 
       </div>
       </div>
   </div>
...
<script type="event_template" id="eventTemplate">
  {{#if productEvent}}
    <div class="in_dsc">[네이버예약 특별할인]<br>{{productEvent}}</div>
  {{else}}
    <div class="in_dsc">현재 진행중인 이벤트가 없습니다.</div>
  {{/if}}
</script>
...
<div class="store_info">
    <div class="store_addr_wrap">
        ...
        <p class="store_addr addr_detail">
			{{placeName}}
		</p>
    </div>
        ...
        <ul class="lst_store_info">
            <li class="item"> 
				...
				<span class="item_rt">
					...
					{{else}}
						<a href="#" style="color:gray">등록된 전화번호가 없습니다.</a>
					{{/if}}
				</span>
			</li>
        </ul>
