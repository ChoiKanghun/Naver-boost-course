...
<body>
	<div id="email" style="display:none" data-email="${reservationEmail }"></div>
	<div id="reservationInfoId" style="display:none" data-reservation-info-id="${reservationInfoId }"></div>
	<div id="productId" style="display:none" data-product-id="${productId }"></div>
	<div id="productDescription" style="display:none">${productDescription }</div>
	<div id="container">
			...
			<div class="ct_wrap">
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept=".png, .jpg" multiple>
...
<script src = "js/reviewWrite.js?ver=1.01"></script>
